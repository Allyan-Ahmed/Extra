...
//   document.addEventListener("DOMContentLoaded", updateHorizontalSelector); // Run on page load
  
//   window.addEventListener("resize", () => {
//     setTimeout(updateHorizontalSelector, 500); // Debounce test call on resize
//   });
  
//   const navbarToggler = document.querySelector(".navbar-toggler");
//   navbarToggler.addEventListener("click", () => {
//     document.querySelector(".navbar-collapse").classList.toggle("show"); // Use Bootstrap's show class
//     setTimeout(updateHorizontalSelector, 500);
//   });
